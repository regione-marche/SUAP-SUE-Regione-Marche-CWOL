...
class rsnSigner {
    ...
    public function getSignerLogo() {
        require_once(ITA_LIB_PATH . '/itaPHPARSS/itaARSSLogo.class.php');
    ...
    public function multiSignPkcs7($addSignOnP7m = true) {
        require_once(ITA_LIB_PATH . '/itaPHPARSS/itaARSSClient.class.php');
        require_once(ITA_LIB_PATH . '/itaPHPARSS/itaARSSSignRequestV2.class.php');
        require_once(ITA_LIB_PATH . '/itaPHPARSS/itaARSSIdentity.class.php');
...
//            ));
    ...
    public function signXades($Sessionid = '') {
        require_once(ITA_LIB_PATH . '/itaPHPARSS/itaARSSClient.class.php');
        require_once(ITA_LIB_PATH . '/itaPHPARSS/itaARSSSignRequestV2.class.php');
        require_once(ITA_LIB_PATH . '/itaPHPARSS/itaARSSSXmlSignatureParameter.class.php');
        require_once(ITA_LIB_PATH . '/itaPHPARSS/itaARSSSTrasforms.class.php');
        require_once(ITA_LIB_PATH . '/itaPHPARSS/itaARSSIdentity.class.php');
        require_once(ITA_LIB_PATH . '/itaPHPARSS/itaARSSParam.class.php');
//        $eqAudit = new eqAudit();
//        $eqAudit->logEqEvent($this, array(
