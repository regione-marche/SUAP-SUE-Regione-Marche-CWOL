...
class praTemplateUploadQ extends praTemplateLayout {
...
//        );
        ...
        $tipoPasso = 'MultiUpload Allegati Qualificati';
        ...
        // 3 --  INIZIO BOX INFO
        //
        // PASSO UPLOAD MULTIPLO ALLEGATI QUALIFICATI
        //
        ...
        if ($dati['Ricite_rec']['ITEQALLE'] == 1) {
            ...
            if ($dati['Ricite_rec']['ITEQDEST'] == 1) {
                ...
                foreach ($dati['Anaddo_tab'] as $Anaddo_rec) {
                    $Sel = "";
                    if ($Ricdag_rec['RICDAT'] == $Anaddo_rec['SPACOD'])
                    //$Sel = "selected";
        ...
        $div_upload .= " <a class=\"italsoft-button\" href=\"$urlAvanti\">";
        $div_upload .= '<i class="icon ion-arrow-right-b italsoft-icon"></i>';
        ...
        if ($arrayExt) {
            ...
            foreach ($arrayExt as $ext) {
                ...
                $html->appendHtml("<span style=\"font-size:1.2em;\" class=\"legenda\"><b>" . $ext . "</b></span>" . '&nbsp');
            }
            $html->appendHtml("<br>");
            $html->appendHtml("<br>");
        }
