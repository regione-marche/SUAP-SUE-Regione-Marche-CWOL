...
//        }
    ...
    public function ws_InserisciProtocollo($dati) {
        ...
        if (isset($dati['Mezzo'])) {
            $MezzoInvioSoapval = new soapval('tem:Mezzo', 'tem:Mezzo', $dati['Mezzo'], false, false);
            $paramArr[] = $MezzoInvioSoapval;
        }
        ...
        if (isset($dati['DataRicevimento'])) {
            $DataRicevimentoSoapval = new soapval('tem:DataRicevimento', 'tem:DataRicevimento', $dati['DataRicevimento'], false, false);
            $paramArr[] = $DataRicevimentoSoapval;
        }
        $UtenteSoapval = new soapval('tem:Utente', 'tem:Utente', $this->utente, false, false);
