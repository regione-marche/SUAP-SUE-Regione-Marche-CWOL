...
//        file_put_contents("/users/tmp/FOparam_$operationName" . "_$this->metodo.xml", $param);
//        file_put_contents("/users/tmp/FOrequest_$operationName" . "_$this->metodo.xml", $client->request);
//        file_put_contents("/users/tmp/FOresponse_$operationName" . "_$this->metodo.xml", $client->response);
        $time = time();
        if ($client->fault) {
