...
require_once(ITA_LIB_PATH . '/itaPHPPaleo/itaPaleoClient.class.php');
require_once(ITA_LIB_PATH . '/itaPHPPaleo/itareqProtocolloArrivo.class.php');
require_once(ITA_LIB_PATH . '/itaPHPPaleo/itareqProtocolloPartenza.class.php');
require_once(ITA_LIB_PATH . '/itaPHPPaleo/itaCercaDocumentoProtocollo.class.php');
require_once(ITA_LIB_PATH . '/itaPHPPaleo/itaOperatorePaleo.class.php');

//require_once './apps/Sviluppo/devLib.class.php';
//require_once './apps/Pratiche/praLib.class.php';
//require_once './apps/Accessi/accLib.class.php';
...
//    }
    ...
    private function setClientConfig($paleoClient) {
        $CodAmm = $this->clientParam['WSPALEOCODAMM'];
        $paleoClient->setWebservices_uri($this->clientParam['WSPALEOENDPOINT']);
        $paleoClient->setWebservices_wsdl($this->clientParam['WSPALEOWSDL']);
        $paleoClient->setUsername($CodAmm . "\\" . $this->clientParam['WSPALEOUSERNAME']);
        $paleoClient->setpassword($this->clientParam['WSPALEOPASSWORD']);
        $paleoClient->setTimeout($this->clientParam['WSPALEOTIMEOUT']);
        $this->WsOperatorePaleoUO = $this->clientParam['WSPALEOUNITAOPE'];
        $this->WsOperatorePaleoCognome = $this->clientParam['WSPALEOCOGNOME'];
        $this->WsOperatorePaleoNome = $this->clientParam['WSPALEONOME'];
        $this->WsOperatorePaleoRuolo = $this->clientParam['WSPALEORUOLO'];
