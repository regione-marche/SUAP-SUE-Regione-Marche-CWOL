...
class Markup implements ArrayAccess
{
    ...
    /** @var int The encoding convention used for XSS avoiding */
    ...
    public static function unXSS($input)
    {
	    ...
	    {
	        $return = htmlspecialchars($input, NULL, static::$inputEncoding);
	    }
	    else
	    {
		    $return = htmlentities($input, ENT_QUOTES | ENT_DISALLOWED | static::$outputLanguage, static::$inputEncoding);
	    }
