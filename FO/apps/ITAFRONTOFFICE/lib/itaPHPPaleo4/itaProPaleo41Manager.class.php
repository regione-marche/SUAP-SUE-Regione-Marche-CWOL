...
//    }
    ...
    public static function getInstance($clientParam) {
        try {
            $managerObj = new itaProPaleo41Manager();
    ...
    private function setClientConfig($paleoClient) {
        ...
        $paleoClient->setCurl_ssl_cipher($this->clientParam['WSSSLCIPHERPALEO4']);
...
//        }
        ...
        if ($elementi['dati']['DocumentoPrincipale']) {
            ...
            $reqProtocolloArrivo->setDocumentoPrincipale(array(
                ...
                "MimeType" => $praLib->getMimeType($elementi['dati']['DocumentoPrincipale']['Nome']),
        ...
        if ($elementi['dati']['DocumentiAllegati']) {
            ...
            foreach ($DocAllegati as $key => $record) {
                ...
                $DocAllegati[$key]['Documento']['MimeType'] = $praLib->getMimeType($record['Documento']['Nome']);
