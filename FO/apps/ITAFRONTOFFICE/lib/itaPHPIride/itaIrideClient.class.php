...
//        file_put_contents("/users/tmp/param$operationName.xml", $param);
//        file_put_contents("/users/tmp/request$operationName.xml", $client->request);
//        file_put_contents("/users/tmp/response$operationName.xml", $client->response);
        $time = time();
        if ($client->fault) {
