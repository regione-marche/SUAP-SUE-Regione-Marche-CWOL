...
//        file_put_contents("/users/tmp/response_praWsFrontOffice_$methodName.xml", $client->response);
     ...
     *   'filtri',
     */
    public function ws_RicercaPratiche($param) {
        return $this->ws_call('RicercaPratiche', $param);
    }
     ...
     * @return type string
     */
    public function ws_SetStatoPasso($param) {
        return $this->ws_call('SetStatoPasso', $param);
    }
     ...
     * @return type string
     */
    public function ws_GetBodyFile($param) {
        return $this->ws_call('GetBodyFile', $param);
    }
     ...
     * @return type string
     */
    public function ws_GetPraticaAllegatoFromTestoBase($param) {
        return $this->ws_call('GetPraticaAllegatoFromTestoBase', $param);
    }
     ...
     * 'itaEngineContextToken',
     * 'domainCode',
     * 'fascicolo'   (Jason del record PROGES in baseCode64),
     * @return type
     */
    public function ws_SyncFascicolo($param) {
//        Out::msgInfo("WsParametri", print_r($param,true));
        
        return $this->ws_call('SyncFascicolo', $param);
    }
     ...
     * 'itaEngineContextToken',
     * 'domainCode',
     * 'passo'   (Jason del record PROPAS in baseCode64),
     * @return type
     */
    public function ws_SyncPasso($param) {
//        Out::msgInfo("WsParametri", print_r($param,true));
        
        return $this->ws_call('SyncPasso', $param);
    }
     ...
     * 'itaEngineContextToken',
     * 'domainCode',
     * 'passo'   (codice del passo - PROPAK),
     * @return type
     */
    public function ws_SyncAllegatiInfo($param) {
        
        return $this->ws_call('SyncAllegatiInfo', $param);
    }
     ...
     * 'domainCode',
     * 'passo'   (codice del passo - PROPAK),
     * 'passha2' (Impronta del file)
     * @return type
     */
    public function ws_DeleteAllegatoPasso($param) {
        
        return $this->ws_call('DeleteAllegatoPasso', $param);
    }
     ...
     * 'itaEngineContextToken',
     * 'domainCode',
     * 'stream'   (Contenuto del file baseCodce64 di un file ZIP contenente TXT con i PROPAK dei passi con articoli pubblicati),
     * @return type
     */
    public function ws_SyncAllegatiDelete($param) {
        
        return $this->ws_call('SyncAllegatiDelete', $param);
    }
