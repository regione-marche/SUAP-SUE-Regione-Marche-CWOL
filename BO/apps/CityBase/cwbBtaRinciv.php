...
function cwbBtaRinciv() {
    $cwbBtaRinciv = new cwbBtaRinciv();
    $cwbBtaRinciv->parseEvent();
    return;
}

class cwbBtaRinciv extends cwbBpaGenTab {
    ...
    public function Stampa(){
        ...
        $this->SQL = $this->libDB->getSqlLeggiBtaRinciv($filtri, true);        
        Out::setFocus("", $this->nameForm . '_DALLADATA');
    }
}
