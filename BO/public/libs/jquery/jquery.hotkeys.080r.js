...
(function(jQuery) {
    ...
    function keyHandler(handleObj) {
        ...
        var keys = handleObj.data.combi.toLowerCase().split(",");
        var disableInInput = handleObj.data.disableInInput;
            ...
            for (var i = 0, l = keys.length; i < l; i++) {
                ...
                for (var c = 0; c < sequences.length; c++) {
                    ...
                    if (sequenceKeys && SequencesEqual(sequenceKeys, sequences[c])) {
                        ClearSequence();
                        arguments[0].combi = sequenceKeys.join(";");
                        return origHandler.apply(this, arguments);
                    }
                }

                if (sequenceTimeout == null && possible[ keys[i] ]) {
                    arguments[0].combi = keys[i] ;
                    return origHandler.apply(this, arguments);
                }
            }
        };
