...
(function(window, undefined){
    ...
    window.onload = function()
    {
        ...
        // ---
        // @massimob: al config.json vanno passati i parametri type e domain,
        // in quanto tale file di configurazione viene ricavato da un ws rest
        //xhr.open("get", "./config.json", true);      
        var queryString = '?type=' + window.ooPluginConfig.type + '&domain=' + window.ooPluginConfig.domain;
        xhr.open("get", "./config.json" + queryString, true);
        // ---
