...
//        file_put_contents("C:/Works/PhpDev/data/itaEngine/tmp/param_$operationName" . "_$ditta.xml", $param);
//        file_put_contents("C:/Works/PhpDev/data/itaEngine/tmp/request_$operationName" . "_$ditta.xml", $client->request);
//        file_put_contents("C:/Works/PhpDev/data/itaEngine/tmp/response_$operationName" . "_$ditta.xml", $client->response);
        if ($client->fault) {
    ...
    public function ws_Login($param) {
        ...
        $strUserNameSoapval = new soapval('Username', 'Username', $param['Utente'], false, false, array("xsi:type" => "xsd:string"));
        $strPasswordSoapval = new soapval('UserPassword', 'UserPassword', $param['Password'], false, false, array("xsi:type" => "xsd:string"));
