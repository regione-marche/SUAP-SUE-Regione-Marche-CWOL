...
class WSSESoap {
    ...
    public function addUserToken($userName, $password=NULL, $passwordDigest=FALSE) {
        ...
        $token->setAttribute("wsu:Id", "UsernameToken-15"); // Angelo
		...
		$nonceNode->setAttribute('EncodingType', 'http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-soap-message-security-1.0#Base64Binary'); //Angelo
