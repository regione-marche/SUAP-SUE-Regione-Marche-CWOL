...
class CkBaseProgress {
	...
	function __construct($res=null) {
		...
		if (get_class($this) === 'CkBaseProgress') {
			$_this = null;
		} else {
			$_this = $this;
		}
		$this->_cPtr=new_CkBaseProgress($_this);
	}
...
class CkSFtpProgress extends CkBaseProgress {
	...
	function __construct($res=null) {
		...
		if (get_class($this) === 'CkSFtpProgress') {
			$_this = null;
		} else {
			$_this = $this;
		}
		$this->_cPtr=new_CkSFtpProgress($_this);
	}
}
...
class CkCert {
	...
	function LinkPrivateKey($keyContainerName,$bMachineKeyset,$bForSigning) {
		return CkCert_LinkPrivateKey($this->_cPtr,$keyContainerName,$bMachineKeyset,$bForSigning);
	}
...
class CkCrypt2 {
	...
	function SetCSP($csp) {
		return CkCrypt2_SetCSP($this->_cPtr,$csp);
	}
...
class CkEmail {
	...
	function SetCSP($csp) {
		return CkEmail_SetCSP($this->_cPtr,$csp);
	}
...
class CkImap {
	...
	function SetCSP($csp) {
		return CkImap_SetCSP($this->_cPtr,$csp);
	}
...
class CkMailMan {
	...
	function SetCSP($csp) {
		return CkMailMan_SetCSP($this->_cPtr,$csp);
	}
...
class CkMime {
	...
	function SetCSP($csp) {
		return CkMime_SetCSP($this->_cPtr,$csp);
	}
