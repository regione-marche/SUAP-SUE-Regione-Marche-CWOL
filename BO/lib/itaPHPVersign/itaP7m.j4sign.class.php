    ...
    public function getMessageErrorFileAsString() {
        ...
        if (!$messaggioStruct || $messaggioStruct[0] == "") {
            ...
            foreach ($messaggioStruct as $key => $value) {
                /*
                 * Aggiunto il 06/07/2016 perchè un firmatario puo avere piu errori, quindi $value['messageErrorsSigner']['string']
                 * può essere un array (Per problema SUE Comune di Pesaro
                 */
