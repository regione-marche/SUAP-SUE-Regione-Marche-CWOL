...
class itaP7mARSS extends itaP7m {
    ...
    public static function getInstance($Filep7m) {
        if (file_exists(ITA_BASE_PATH . '/apps/RemoteSign/rsnVerifier.class.php')) {
            require_once ITA_BASE_PATH . '/apps/RemoteSign/rsnVerifier.class.php';
        } elseif (file_exists(ITA_LIB_PATH . '/itaPHPVersign/rsnVerifier.class.php')) {
