...
class Assertion implements SignedElement
{
    ...
    /**
     * Retrieve the subject locality
     * 
     * @return string|null Subject Locality
     */
     ...
     *
     *
     * @param string|null $subjectLocality Sobject locality
     */
    public function setSubjectLocality($subjectLocality)
    {
        assert('is_int($subjectLocality) || is_null($subjectLocality)');
    ...
    {
        //if (!empty($this->authnContextClassRef)) {    // @Massimo Biagioli: rimosso controllo
            return $this->authnContextClassRef;
        //}                                             // @Massimo Biagioli: rimosso controllo
    ...
    private function addAuthnStatement(\DOMElement $root)
    {
        ...
        // @Massimo Biagioli: aggiunto tag SubjectLocality
        $subjectLocalityEl = $document->createElementNS(Constants::NS_SAML, 'saml:SubjectLocality');
        $subjectLocalityEl->setAttribute('Address', $this->subjectLocality);
        $authnStatementEl->appendChild($subjectLocalityEl);
        // @Massimo Biagioli: aggiunto tag SubjectLocality
