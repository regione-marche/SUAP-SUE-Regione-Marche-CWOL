...
//        file_put_contents('/tmp/param.xml', $param);
                        ...
                        <xs:element name="mittente">
                           <xs:complexType>
                              <xs:sequence>
                                 ...
                                 <xs:element name="codice_ufficio" minOccurs="0" type="xs:string"/>
                              </xs:sequence>
                           </xs:complexType>
                        </xs:element>
                        <xs:element name="destinatario">
                           <xs:complexType>
                              <xs:sequence>
                                 ...
                                 <xs:element name="codice_ufficio" minOccurs="0" type="xs:string"/>
                                 <xs:element name="descrizione_ufficio" minOccurs="0" type="xs:string"/>
                              </xs:sequence>
                           </xs:complexType>
                        </xs:element>
