...
//        file_put_contents("/users/tmp/response_$operationName" . "_$ditta.xml", $client->response);
    ...
    public function ws_Protocollazione($dati) {
         ...
         *              Fascicolo
         *                              Valore
         *                              Attributi (numero => "53", anno => "2013")
         * Descrizione
         *              Documento
         *                              DescrizioneDocumento
         *                              TipoDocumento
         *                              Attributi (nome => "CI.jpg", id => "5")
         *              Allegati
         *                              Documento
         *                                      DescrizioneDocumento
         *                                      TipoDocumento
                ...
                if (is_array($dati['Intestazione']['Mittente'])) {
                    foreach ($dati['Intestazione']['Mittente'] as $Mittente) {
                        ...
                        if (is_array($Mittente['Amministrazione'])) {
                            ...
                            $AmministrazioneSoapvalArr[] = new soapval('IndirizzoTelematico', 'IndirizzoTelematico', $Mittente['Amministrazione']['IndirizzoTelematico'], false, false);
...
//                    $IntestazioneSoapvalArr[] = new soapval('Destinatario', 'Destinatario', $DestinatarioSoapvalArr, false, false);
            ...
            //Fascicolo
            if (isset($dati['Intestazione']['Fascicolo'])) {
        ...
        /*
         * Sezione Parametri Applicativo Protocollo
         */
        if (is_array($dati['parametri'])) {
            $AppProtocolloSoapvalArr = array();
            foreach ($dati['parametri'] as $parametro) {
                $AppProtocolloSoapvalArr[] = new soapval('Parametro', 'Parametro', "", false, false, $parametro['Attributi']);
            }
        }

        if ($AppProtocolloSoapvalArr) {
            $AppProtocolloSoapval = new soapval('ApplicativoProtocollo', 'ApplicativoProtocollo', $AppProtocolloSoapvalArr, false, false, array("nome" => "ArchiPRO"));
            $paramArr[] = $AppProtocolloSoapval;
        }
