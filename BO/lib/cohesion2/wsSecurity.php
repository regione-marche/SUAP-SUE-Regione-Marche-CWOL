...
class WSASoap {
    ...
    public function addCohesion(){
            $header = $this->locateHeader();   
            $cohesion = $this->soapDoc->createElementNS('http://uddi.regione.marche.it/Cohesion','co:Cohesion');
            $header->appendChild($cohesion);
            $enteId = $this->soapDoc->createElementNS('http://uddi.regione.marche.it/Cohesion', 'co:EnteId', 'inf-tossici');
            $cohesion->appendChild($enteId);
            $profUtente = $this->soapDoc->createElementNS('http://uddi.regione.marche.it/Cohesion','co:ProfiloUtente');
            $cohesion->appendChild($profUtente);
    }
