...
class nusoap_server extends nusoap_base {
    ...
    function parseRequest($headers, $data) {
        ...
        app::log('chiamata qui');
        $parser = new nusoap_parser($data, $this->xml_encoding, '', $this->decode_utf8 = false);
        // parser debug
...
//	function nusoap_parser($xml,$encoding='UTF-8',$method='',$decode_utf8=true){
    function nusoap_parser($xml, $encoding = 'ISO-8859-1', $method = '', $decode_utf8 = false) {
        parent::nusoap_base();
        $this->xml = $xml;
            ...
            if ($pos_xml !== FALSE) {
                ...
                if (preg_match("/encoding=[\"']([^\"']*)[\"']/", $xml_decl, $res)) {
                    ...
                    if (strtoupper($xml_encoding) != $encoding) {
                        ...
                        $this->debug($err);
                        app::log('differenza - riga 6615');
                        app::log($encoding);
                        app::log($xml_encoding);
